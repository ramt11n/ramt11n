# Hi there, I'm Ramtin Neshatvar Ghaleh! 👋
...
**Role:** Engineer
A distributed handwritten digit recognition engine using Python multiprocessing & MapReduce.
* **Tech:** Python, NumPy.
* **Key Feature:** Features a custom Neural Network built from scratch (no ML libs) trained on MNIST.
